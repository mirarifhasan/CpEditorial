...
namespace CpEditorial.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string query = "select top 10 Editorial.EditorialID, Editorial.UpVote, Editorial.DownVote, Editorial.Solution, Problem.Title from Editorial, Problem, [User] where Editorial.ProblemID=Problem.ProblemID AND Editorial.UserID=[User].UserID and approve='Yes';";
